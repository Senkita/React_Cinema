...
app.use(function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var videoList, videoTypeList, files, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                videoList = [];
                videoTypeList = ["mp4", "mkv"];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, promises_1.readdir)("/opt/Downloads")];
            case 2:
                files = _a.sent();
                files.forEach(function (file) {
                    var fileExtName = (0, node_path_1.extname)(file).slice(1);
